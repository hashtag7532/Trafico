...
const How = ({howData}) => {
  ...
  return <section className="mb-[60px] lg:mb-[160px]">
    <div className="mx-auto container">
      <motion.div variants={staggerTextContainer} initial="initial" whileInView={'animate'} viewport={{once:false, amount:0.6}} className="flex flex-col lg:flex-row gap-x-10 items-center">
        <motion.div variants={fadeInRight} className="flex-1">
          <Image src={girlImg} width={720} height={678} />
        </motion.div>
        <motion.div variants={fadeInLeft} className="flex-1 justify-end">
